<template>
  <div class="p-2" style="display: flex;flex-direction: column; /* 设置子元素垂直排列 */justify-content: center;align-items: center;">
    <!--  热门课程  -->
    <el-card shadow="hover" class="hot-card" style="margin-bottom:32px">
      <transition :enter-active-class="proxy?.animate.searchAnimate.enter"
                  :leave-active-class="proxy?.animate.searchAnimate.leave">
        <div v-show="showSearch" class="search">
          <el-form :inline="true" label-width="68px">
            <el-form-item label="课程名称" prop="name">
              <el-input v-model="hotPage.name" clearable placeholder="请输入课程名称" style="width: 240px"/>
            </el-form-item>
            <el-form-item>
    ...
    <!--  非热门课程  -->
    <el-card shadow="hover" class="not-hot-card" style="margin-bottom:32px">
      <transition :enter-active-class="proxy?.animate.searchAnimate.enter"
                  :leave-active-class="proxy?.animate.searchAnimate.leave">
        <div v-show="showSearch" class="search">
          <el-form :inline="true" label-width="68px">
            <el-form-item label="课程名称" prop="name">
              <el-input v-model="notHotPage.name" clearable placeholder="请输入课程名称" style="width: 240px"/>
            </el-form-item>
            <el-form-item>
...
import {addHot, delHot, getESCourseData, getHotIds} from "@/api/course/Hot";
...
const hotColumns: Column<any>[] = [
  ...
  },
  {
    ...
    width: 150,
    align: 'center',
    cellRenderer: ({rowData}) => <p>{showCategoryById(rowData ['mt'], rowData ['st'])}</p>,
  },
  {
    key: 'pic',
    dataKey: 'pic',
  ...
  },
  {
    ...
    width: 150,
    align: 'center',
    cellRenderer: ({cellData}) => <ElTag type={cellData ? 'warning' : 'primary'}>{cellData ? '付费' : '免费'}</ElTag>,
  },
  {
    key: 'originalPrice',
