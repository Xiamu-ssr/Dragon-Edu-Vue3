<template>
  <div style="width: 100%;display: flex;flex-direction: column; /* 设置子元素垂直排列 */justify-content: center;align-items: center;font-family:CuHei;">
    ...
    <div class="flex flex-wrap" style="width: 1200px;margin-top: 20px">
      <el-card
        v-for="(courseBase, index) in hotList"
        shadow="hover"
      ...
      >
        ...
        <div style="height: 50px; border:double;font-size: 20px;">
          <span>{{ courseBase.name }}{{ courseBase.name }}{{ courseBase.name }}</span>
        </div>
        <div style="height: 40px; border:double;">
          <el-rate
